      ...
      <div className="stats">
        <div className="counter">
          <div className="countTitle">Counter</div>
          {
            recordCount 
            ? 
              <div className="countNum" style={{'color': color, 'fontWeight': fontWeight}}>
        ...
        <div className="time">
          ...
          {recordTime ?
            <div className="timeNum" style={{'color': color, 'fontWeight': fontWeight}}>
              ...
              <span>{("0" + Math.floor((clock / 60000) % 60)).slice(-2)}:{("0" + Math.floor((clock / 1000) % 60)).slice(-2)}.{("0" + ((clock / 10) % 100)).slice(-2)}</span>
            </div>
            :
